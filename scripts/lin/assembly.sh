...
function MakeProject {
    ...
    cmake ../../${PROJECT_NAME}/script/cmake_codeblocks.sh -B../../generated/${PROJECT_NAME}/$1 -DCMAKE_GENERATOR_PLATFORM=x64 -DCMAKE_BUILD_TYPE=%BUILD_TYPE% -DURHO3D_64BIT=1 -DURHO3D_THREADING=1 -DURHO3D_LUA=0 -DURHO3D_LUAJIT=0 -DURHO3D_ANGELSCRIPT=1 -DURHO3D_OPENGL=1 -DURHO3D_LIB_TYPE=SHARED -DURHO3D_STATIC_RUNTIME=0 -DURHO3D_IK=0 -DURHO3D_WEBP=0 -DURHO3D_SAMPLES=%ENABLED_SAMPLES% -DURHO3D_DATABASE_SQLITE=1
}
